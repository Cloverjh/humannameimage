        ...
        JSON.stringify(
          {
            ...
            designDNA: decoratedTitle.prompt.designSpec.designDNA,
            contentSummary: decoratedTitle.prompt.designSpec.contentSummary ?? null,
            topicCategories: decoratedTitle.prompt.designSpec.topicCategories ?? [decoratedTitle.prompt.designSpec.topicCategory],
            visualMetaphor: decoratedTitle.prompt.designSpec.visualMetaphor,
            lineBreakPlan: decoratedTitle.prompt.designSpec.lineBreakPlan,
            titlePlacement: decoratedTitle.prompt.designSpec.titlePlacement,
